...
class ContactoForm(forms.ModelForm):
    class Meta:
        model = Contacto
        fields = ['nombre', 'correo', 'empresa', 'linkedin', 'github', 'habilidades', 'descripcion']
        widgets = {
            ...
            'descripcion': forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'Descripción profesional completa'}),
        }